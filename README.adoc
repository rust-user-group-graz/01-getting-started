...
In particular, the following command was used: `pandoc -t revealjs -s -o rustgraz_talk_01.html rustgraz_talk_00.md --self-contained --standalone -V theme=white -V revealjs-url=https://revealjs.com`
